		...
		<div class="row content">
			...
			<form action="insert.do" method="post" class="form-horizontal">
			  ...
			  <div class="form-group">
			    ...
			    <div class="col-sm-10">
			      <input type="text" name="pay" class="pay" id="pay" placeholder="금액을 입력하세요">
			    </div>
			  </div>
			  <div class="form-group">
